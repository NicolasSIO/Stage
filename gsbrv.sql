...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `gsbrv` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Motif` (
  `mo_code` varchar(10) NOT NULL DEFAULT '',
  `mo_libelle` varchar(40) NOT NULL,
  PRIMARY KEY (`mo_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Motif` VALUES ('actu','Actualisation'),('info','Informer'),('nouv','Nouveauté'),('perio','Périodicité');
...
CREATE TABLE `RapportVisite` (
  ...
  `rap_lu` BOOLEAN NOT NULL DEFAULT FALSE,
  `rap_date_redaction` date NOT NULL,
  `rap_coeff_confiance` int(2) NOT NULL,
  `pra_num` int(11) DEFAULT NULL,
  `mo_code` varchar(10) NOT NULL DEFAULT '',
  PRIMARY KEY (`vis_matricule`,`rap_num`),
  KEY `FK_RAPPORT_VISITE_PRATICIEN` (`pra_num`),
  KEY `FK_RAPPORT_VISITE_MOTIF` (`mo_code`),
  CONSTRAINT `FK_RAPPORT_VISITE_MOTIF` FOREIGN KEY (`mo_code`) REFERENCES `Motif` (`mo_code`),
...
INSERT INTO `RapportVisite` VALUES ('a131',1,'2018-03-01','RAS','2018-03-04',13,22,'actu'),('a131',2,'2018-04-02','RAS','2018-04-05',11,22,'perio'),('a131',3,'2018-04-03','RAS','2018-04-06',12,18,'info'),('a131',4,'2018-05-10','RAS','2018-05-13',14,22,'perio'),('a131',5,'2018-05-21','RAS','2018-05-21',10,18,'nouv');
...
INSERT INTO `Visiteur` VALUES ('a131','azerty','Villechalane','Louis','8 cours Lafontaine','29000','BREST','2012-11-08',NULL,'SW'),('a17','azerty','Andre','David','1 rue Aimon de Chissee','38100','GRENOBLE','2008-06-19',NULL,'GY'),('a55','azerty','Bedos','Christian','1 rue Bénédictins','65000','TARBES','2007-09-07',NULL,'GY'),('a93','azerty','Tusseau','Louis','22 rue Renou','86000','POITIERS','2001-02-09',NULL,'SW'),('b13','azerty','Bentot','Pascal','11 avenue 6 Juin','67000','STRASBOURG','2003-11-06',NULL,'GY'),('b16','azerty','Bioret','Luc','1 rue Linne','35000','RENNES','2003-01-06',NULL,'SW'),('b19','azerty','Bunisset','Francis','10 rue Nicolas Chorier','85000','LA ROCHE SUR YON','2013-09-23',NULL,'GY'),('b25','azerty','Bunisset','Denise','1 rue Lionne','49100','ANGERS','2007-03-04',NULL,'SW'),('b28','azerty','Cacheux','Bernard','114 rue Authie','34000','MONTPELLIER','2008-02-10',NULL,'GY'),('b34','azerty','Cadic','Eric','123 rue Caponière','41000','BLOIS','2012-06-03','P','SW'),('b4','azerty','Charoze','Catherine','100 place Géants','33000','BORDEAUX','2009-05-07',NULL,'SW'),('b50','azerty','Clepkens','Christophe','12 rue Fédérico Garcia Lorca','13000','MARSEILLE','2011-08-18',NULL,'SW'),('b59','azerty','Cottin','Vincenne','36 square Capucins','5000','GAP','2010-12-19',NULL,'GY'),('c14','azerty','Daburon','François','13 rue Champs Elysées','6000','NICE','2012-01-20','S','SW'),('c3','azerty','De','Philippe','13 rue Charles Peguy','10000','TROYES','2005-05-29',NULL,'SW'),('c54','azerty','Debelle','Michel','181 rue Caponière','88000','EPINAL','2004-09-19',NULL,'SW'),('d13','azerty','Debelle','Jeanne','134 rue Stalingrad','44000','NANTES','2012-05-25',NULL,'SW'),('d51','azerty','Debroise','Michel','2 avenue 6 Juin','70000','VESOUL','2011-08-17','E','GY'),('e22','azerty','Desmarquest','Nathalie','14 rue Fédérico Garcia Lorca','54000','NANCY','2013-04-18',NULL,'GY'),('e24','azerty','Desnost','Pierre','16 rue Barral de Montferrat','55000','VERDUN','2013-04-18','E','SW'),('e39','azerty','Dudouit','Frédéric','18 quai Xavier Jouvin','75000','PARIS','2013-04-18',NULL,'GY'),('e49','azerty','Duncombe','Claude','19 avenue Alsace Lorraine','9000','FOIX','2012-09-16',NULL,'GY'),('e5','azerty','Enault-Pascreau','Céline','25B rue Stalingrad','40000','MONT DE MARSAN','2012-09-16','S','GY'),('e52','azerty','Eynde','Valérie','3 rue Henri Moissan','76000','ROUEN','2012-09-16',NULL,'GY'),('f21','azerty','Finck','Jacques','route Montreuil Bellay','74000','ANNECY','2012-09-16',NULL,'SW'),('f39','azerty','Frémont','Fernande','4 rue Jean Giono','69000','LYON','2005-05-29',NULL,'GY'),('f4','azerty','Gest','Alain','30 rue Authie','46000','FIGEAC','2005-05-29',NULL,'GY'),('g19','azerty','Gheysen','Galassus','32 boulevard Mar Foch','75000','PARIS','2005-05-29',NULL,'SW'),('g30','azerty','Girard','Yvon','31 avenue du 6 Juin','80000','AMIENS','2012-05-25','N','GY'),('g53','azerty','Gombert','Luc','32 rue Emile Gueymard','56000','VANNES','2012-05-25',NULL,'GY'),('g7','azerty','Guindon','Caroline','40 rue Mar Montgomery','87000','LIMOGES','2012-05-25',NULL,'GY'),('h13','azerty','Guindon','François','44 rue Picotière','19000','TULLE','2012-05-25',NULL,'SW'),('h30','azerty','Igigabel','Guy','33 rue Arlequin','94000','CRETEIL','2008-06-19',NULL,'SW'),('h35','azerty','Jourdren','Pierre','34 avenue Jean Perrot','15000','AURRILLAC','2008-06-19',NULL,'GY'),('h40','azerty','Juttard','Pierre-Raoul','34 cours Jean Jaurès','8000','SEDAN','2008-06-19',NULL,'GY'),('j45','azerty','Euré-Morel','Saout','38 cours Berriat','52000','CHAUMONT','2008-06-19','N','SW'),('j50','azerty','Landré','Philippe','4 avenue du Général Laperrine','59000','LILLE','2000-05-01',NULL,'GY'),('j8','azerty','Langeard','Hugues','39 avenue Jean Perrot','93000','BAGNOLET','2000-05-01','P','GY'),('k4','azerty','Lanne','Bernard','4 rue Bayeux','30000','NIMES','2000-05-01',NULL,'SW'),('k53','azerty','Le','Noël','4 avenue Beauvert','68000','MULHOUSE','2000-05-01',NULL,'SW'),('l14','azerty','Le','Jean','39 rue Raspail','53000','LAVAL','2000-05-01',NULL,'SW'),('l23','azerty','Leclercq','Servane','11 rue Quinconce','18000','BOURGES','1998-11-23',NULL,'SW'),('l46','azerty','Lecornu','Jean-Bernard','4 boulevard du Maréchal Foch','72000','LA FERTE BERNARD','1998-11-23',NULL,'GY'),('l56','azerty','Lecornu','Ludovic','4 rue Abel Servien','25000','BESANCON','1998-11-23',NULL,'SW'),('m35','azerty','Lejard','Agnès','4 rue Anthoard','82000','MONTAUBAN','1998-11-23',NULL,'SW'),('m45','azerty','Lesaulnier','Pascal','47 rue Thiers','57000','METZ','1998-11-23',NULL,'SW'),('n42','azerty','Letessier','Stéphane','5 chemin de Capuche','27000','EVREUX','1998-11-23',NULL,'GY'),('n58','azerty','Loirat','Didier','12 avenue Bourg la Croix','45000','ORLEANS','1998-11-23',NULL,'GY'),('n59','azerty','Maffezzoli','Thibaud','5 rue Chateaubriand','2000','LAON','2005-12-21',NULL,'SW'),('o26','azerty','Mancini','Anne','5 rue D\'\'Agier','48000','MENDE','2005-12-21',NULL,'GY'),('p32','azerty','Marcouiller','Gérard','7 place St Gilles','91000','ISSY LES MOULINEAUX','2005-12-21',NULL,'GY'),('p40','azerty','Michel','Jean-Claude','5 rue Gabriel Péri','61000','FLERS','2005-12-21','O','SW'),('p41','azerty','Montecot','Françoise','6 rue Paul Valéry','17000','SAINTES','2005-12-21',NULL,'GY'),('p42','azerty','Notini','Veronique','5 rue du Lieutenant Chabal','60000','BEAUVAIS','2005-12-21',NULL,'SW'),('p49','azerty','Onfroy','Den','5 rue Sidonie Jacolin','37000','TOURS','2005-12-21',NULL,'GY'),('p6','azerty','Pascreau','Charles','57 boulevard Mar Foch','64000','PAU','1997-03-30',NULL,'SW'),('p7','azerty','Pernot','Claude-Noël','6 rue Alexandre 1 de Yougoslavie','11000','NARBONNE','2003-01-02',NULL,'SW'),('p8','azerty','Perrier','Maître','6 rue Aubert Dubayet','71000','CHALON SUR SAONE','2006-06-23',NULL,'GY'),('q17','azerty','Petit','Jean-Louis','7 rue Ernest Renan','50000','SAINT LO','2009-06-07',NULL,'GY'),('r24','azerty','Piquery','Patrick','9 rue Vaucelles','14000','CAEN','2007-04-29','O','GY'),('r58','azerty','Quiquandon','Joëll','7 rue Ernest Renan','29000','QUIMPER','2006-09-30',NULL,'GY'),('s10','azerty','Retailleau','Josselin','88 bis rue Saumuroise','39000','DOLE','2011-12-05',NULL,'SW'),('s21','azerty','Retailleau','Pascal','32 boulevard Ayrault','23000','MONTLUCON','2009-05-09',NULL,'SW'),('t43','azerty','Souron','Maryse','7B rue Gay Lussac','21000','DIJON','2003-09-03',NULL,'SW'),('t47','azerty','Tiphagne','Patrick','7B rue Gay Lussac','62000','ARRAS','1997-08-29',NULL,'SW'),('t55','azerty','Tréhet','Alain','7D chemin Barral','12000','RODEZ','1994-11-29',NULL,'SW'),('t60','azerty','Tusseau','Josselin','63 rue Bon Repos','28000','CHARTRES','1991-03-29',NULL,'GY');
...
-- Dump completed on 2019-02-19 14:35:27
